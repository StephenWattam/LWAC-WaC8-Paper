...
\frame{\frametitle{Issues}
    \begin{itemize}
        ...
        \vspace{10pt}
        \item Manual supervisision required
        \vspace{10pt}
...
\frame{\frametitle{Data}
    \begin{itemize}
        ...
        \vspace{5pt}
        \item Format, size filters to exclude unwanted types
    \end{itemize}  
...
\frame{\frametitle{Download Model}
...
\begin{itemize}
    ...
    \item Controls sampling policy centrally
        \vspace{5pt}
    \item Normalises data format (character encoding, headers)
        \vspace{5pt}
...
\begin{itemize}
    ...
    \vspace{10pt}
    \item Latency of DNS servers
    \vspace{10pt}
    \item Latency/speed of resultant servers
\end{itemize}    
}
...
\frame{\frametitle{Throughput (1 worker)}
    \includegraphics[width=\textwidth]{parallelrate}
}



\frame{\frametitle{Throughput (n workers)}
% TODO
...
\begin{itemize}
    ...
    \item 228,000 URLs: 5000 requests, 50 links/call
\end{itemize}    

System:
\begin{itemize}
    \item 3 clients, 400 parallel downloads each (~300k links/hour)
\end{itemize}    

Throughput
\begin{itemize}
    \item 14.9GB in 45 minutes (5.6MBps, 300,000 links/hour)
    \vspace{10pt}
    \item 
\end{itemize}    
}
